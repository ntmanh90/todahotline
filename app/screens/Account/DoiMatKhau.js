...
import { Platform, View, SafeAreaView, StyleSheet, Text, Image, Alert } from 'react-native';
    ...
    return (
        <>
            <View style={styles.container}>
                ...
                <Button title="Đổi mật khẩu" onPress={handleDoiMatKhau} containerStyle={styles.borderButton} buttonStyle={{ borderRadius: 20 }} />
            </View>
