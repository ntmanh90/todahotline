...
class RNCallKeep {
  ...
  // checkAlertWindow = async() => {
  //   if(isIOS) return;

  //   var hasPermission = await RNCallKeepModule.checkDrawPermission();
  //   const shouldOpen = await this._alert({ alertTitle: 'Cấp quyền hiển thị' ,
  //                                         alertDescription: 'Bạn cần bật quyền hiển thị ứng dụng trên cùng để thực hiện chức năng gọi điện.' , 
  //                                         okButton: 'Đồng ý' ,
  //                                         cancelButton: 'Để sau'}, !hasPermission);

  //   if (shouldOpen) {
  //     RNCallKeepModule.openDrawSetting();
  //   }
  // }
  ...
  requestDismissKeyguard = () =>  {
    RNCallKeepModule.requestDismissKeyguard();
  }
  ...
  _setupAndroid = async (options) => {
    ...
    // const showAccountAlert = await RNCallKeepModule.showAccountAlert();
